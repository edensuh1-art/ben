...
public class LoginView extends VBox {
    ...
    public LoginView(Stage stage) {
            ...
            try {
                ...
                try {
                    ...
                    if (userFile.password == null || userFile.password.isEmpty()) {
                        ...
                        SaveLoadService.saveUser(userFile);
                ...
                stage.getScene().setRoot(new HelloView(username, password, loginSuccessful));
        ...
        Button visitButton = new Button("Continue as visiter");
        visitButton.setPrefWidth(150);
        visitButton.setStyle("-fx-font-size: 16px;");
        visitButton.setOnAction(e -> {
            stage.getScene().setRoot(new HelloView("Visiter", "", loginSuccessful));
            stage. getScene().getRoot().setStyle("-fx-background-color: lightblue;");
        });


        getChildren().addAll(loginForm, loginButton, visitButton);
