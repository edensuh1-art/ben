...
public class Player implements java.io.Serializable {
	...
	public Player(String name){
		if (name == null || name.isBlank()) throw new IllegalArgumentException("Player must have a name.");
		idCounter++;
	...
	public void setTeam(Team team) { if (team != null) this.team = team;  teamID = team.getID(); }
