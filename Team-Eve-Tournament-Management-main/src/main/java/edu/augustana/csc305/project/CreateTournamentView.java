...
public class CreateTournamentView extends VBox {
    ...
    public CreateTournamentView(ObservableList<Tournament> store, ObservableList<Team> teams, String username, String passward) {
        ...
        teamPlayers.setPrefWidth(200); // ajust as is fit
        ...
        addTeam.setOnAction(e -> {
            ...
            if (teamName.isEmpty()) { 
				new Alert(Alert.AlertType.ERROR, "Team name requires.").showAndWait();
                return;
            }
        ...
        save.setOnAction(e -> {
            ...
            try {
                ...
                //User user = new Organizer("TempUser", "TempUser");
                //saveTournaments(user.getUserFile, tournamentName); //find way to have user accessable from all views
