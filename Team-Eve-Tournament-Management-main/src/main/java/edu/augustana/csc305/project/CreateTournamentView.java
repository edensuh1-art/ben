...
public class CreateTournamentView extends VBox {
    ...
    public CreateTournamentView(ObservableList<Tournament> store, ObservableList<Team> teams) {
        this.teams = teams;
        setSpacing(10);
        ...
        TextField time   = new TextField("08:00 am"); // hh:mm am/pm
        ...
        addTeam.setOnAction(e -> {
            ...
            for (String playerName : playerList){
                ...
                if (!trimmedName.isEmpty()) {
                    teamPlayerList.add(new Player(trimmedName));
                }
            }
