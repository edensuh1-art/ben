...
public class HelloView extends BorderPane {
    ...
    public HelloView() {
        ...
        CreateTournamentView createView = new CreateTournamentView(store, teams);

        tabs.getTabs().add(new Tab("Tournaments", new TournamentView(store)));
        tabs.getTabs().add(new Tab("Create",      createView));
        tabs.getTabs().add(new Tab("Players",     new PlayerView(teams)));
