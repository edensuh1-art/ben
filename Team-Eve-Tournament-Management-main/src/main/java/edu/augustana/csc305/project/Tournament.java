...
public class Tournament implements java.io.Serializable {
    ...
    public void addMatchesToRunning(List<Match> matches) {
        if (matches != null && !matches.isEmpty()) {
            runningMatches.addAll(matches);
        }
    }
    ...
    public void setPools(List<Pool> poolsList) {
        if (poolsList != null && !poolsList.isEmpty()) {
            this.pools = poolsList;
        }
    }

    public void addPools(List<Pool> poolsList) {
        if (poolsList != null && !poolsList.isEmpty()) {
            this.pools.addAll(poolsList);
        }
    }
    ...
    public void setCategory(String category) {
        ...
        if (trimmed.equalsIgnoreCase("Volleyball")) {
            this.category = "Volleyball";
        } else if (trimmed.equalsIgnoreCase("Soccer")) {
            this.category = "Soccer";
        }
    }
    //bracket methods
    public void generateBracket() {
        if ("Volleyball".equals(category)) {
            return;
        } else if ("Soccer".equals(category)) {
            return;
        }
    }
